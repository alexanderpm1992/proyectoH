          ...
          <section class="wrapper">
      		<div class="row mt">
      			...
      			<div id="register-wraper">
        		    <form id="register-form" class="form" method="POST" action="agregarhotel.php">
        		        ...
        		        <div class="body">
							...
							<br />
							<!-- razon social-->
    		        		<label for="surname">Razon Social</label>
    		        		<input name="razonsocial" class="input-huge" type="text">
							<br />
							<br /> 
        		        	<!-- rut del hotel -->
        		        	<label>Rut del Hotel</label>
        		        	<input name="rut" class="input-huge" type="text">
							<br />
							<br /> 
        		        	<!-- nombre de contacto -->
        		        	<label>Nombre de Contacto</label>
        		        	<input name="nombrecontacto" class="input-huge" type="text">
							<br />
							<br /> 
        		        	<!-- correo -->
        		        	<label>Email</label>
    		        		...
    		        		<input name="direccion" class="input-huge" type="text">
							<br /> 
							<br />
							<!-- telefono -->
							<label>Telefono de Contacto</label>
    		        		<input name="telefono" class="input-huge" type="text">
      			...
      			<div class="col-lg-6 col-md-6 col-sm-12">
      				<! -- ALERTS EXAMPLES -->
      				<div class="showback">
      					<h4><i class="fa fa-angle-right"></i> Hoteles Registrados Recientemente</h4>
...
include('conexion.php');  
    ...
    $sql= "SELECT * FROM hotel";     // Esta linea hace la consulta 
